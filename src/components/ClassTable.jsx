          ...
          {data.map((item, index) => (
            <React.Fragment key={index}>
              <tr className="border-t">
                ...
                <td className="py-2 px-3 text-center">
                  <a href="#" className="text-[#0662C6] hover:underline">View Results</a>
                </td>
                <td className="py-2 px-3 text-center">
                  <div className="flex justify-center space-x-2">
                    <button className="px-2 py-1 border border-blue-500 text-[#0662C6] rounded hover:bg-blue-50">Homework</button>
                    <button className="px-2 py-1 border border-blue-500 text-[#0662C6] rounded hover:bg-blue-50">Time Table</button>
                    <button className="px-2 py-1 border border-blue-500 text-[#0662C6] rounded hover:bg-blue-50">Subjects</button>
                  </div>
                </td>
                <td className="py-2 px-3 text-center">
                  <div className="flex justify-center space-x-2">
