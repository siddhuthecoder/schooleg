  ...
  return (
    <nav className="flex justify-between items-center bg-white py-4 px-8 shadow-md">
      ...
      <div className="flex space-x-8 text-gray-500">
        ...
        <a href="/studentdashboard" className="hover:text-black hover:border-b-2 hover:border-blue-600">Dashboard</a>
        <a href="/Bus" className="hover:text-black hover:border-b-2 hover:border-blue-600">Buses</a>
        ...
        <a href="/Banner" className="text-blue-600 border-b-2 border-blue-600">Banner</a>
