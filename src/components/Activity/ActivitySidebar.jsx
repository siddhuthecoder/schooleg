  ...
  return (
    <div className="h-screen w-16 bg-gray-100 flex flex-col items-center py-4 space-y-4">
      ...
      <div className="flex-grow space-y-2">
        ...
        <a href="/classes" className="hover:text-blue-500"><IconButton icon={<MdOutlineClass />} /></a>
        ...
        <a href="/holidays" className="hover:text-blue-500"><IconButton icon={<FaUmbrellaBeach />} /></a>
        <a href="/announcements" className="hover:text-blue-500"><IconButton icon={<FaBullhorn />} /></a>
        <a href="/reminder" className="hover:bg-blue-500"><IconButton icon={<FaBell />} /></a>
        <a href="/notice" className="hover:bg-blue-500"><IconButton icon={<FaExclamationCircle />} /></a>
      </div>

      {/* Logout Icon */}
      <div className="mt-auto mb-2">
        <div className="text-red-600">
          <IconButton icon={<FaExclamationCircle />} /> {/* Replace with your logout icon */}
        </div>
      </div>
    </div>
  );
