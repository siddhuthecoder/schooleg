    ...
    <div className="container mx-auto p-4">
      ...
      <div className="flex justify-between items-center mb-4">
        ...
        <div className="flex space-x-8 text-gray-600">
          ...
          <a href="#" className="text-blue-600 border-b-2 border-blue-600">Progress</a>
          <a href="#" className="hover:text-blue-600">Fees History</a>
          <a href="#" className="hover:text-blue-600">School Bus</a>
        </div>
      </div>
