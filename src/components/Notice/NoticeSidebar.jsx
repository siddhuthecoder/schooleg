...
import { FaUserGraduate, FaChalkboardTeacher, FaUserFriends, FaUserAlt , FaBullhorn, FaBell, FaExclamationCircle } from "react-icons/fa"; // Import your icons
  ...
  return (
    <div className="h-screen w-16 bg-gray-100 flex flex-col items-center py-4 space-y-4">
      ...
      <div className="flex-grow space-y-2">
        ...
        <a href="/notice" className="text-blue-500"><IconButton icon={<FaExclamationCircle />} /></a>
      </div>
