...
import { FaBell, FaDownload, FaPlus } from 'react-icons/fa'; // For icons
import AddBusModal from './AddBusModal'; // Import the modal component
...
const BusHeader = () => {
  ...
  return (
    <div>
      <div className="flex justify-between items-center p-4 bg-white shadow-md">
        ...
        <div className="flex border border-gray-300 rounded-lg text-sm">
          ...
          <div className="flex items-center px-3 py-2 bg-blue-50 text-blue-700 border-r border-gray-300">
            All Vehicles <span className="ml-2 font-bold">50</span>
          </div>
          {/* Running Vehicles */}
        ...
        {/* Search, GPS Alert, Download Button, Add Bus */}
        <div className="flex items-center space-x-4">
          ...
          <button
            ...
            className="flex items-center bg-[#0662C6] text-white py-2 px-4 rounded-lg"
          >
      ...
      {/* Add Bus Modal */}
      {isModalOpen && <AddBusModal isOpen={isModalOpen} onClose={handleModalClose} />}
    </div>
  );
};
